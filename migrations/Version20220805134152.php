 ...
 */
final class Version20220805134152 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE brand_category (id INT AUTO_INCREMENT NOT NULL, trendy_brands VARCHAR(55) DEFAULT NULL, luxury_brands VARCHAR(55) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product_category (id INT AUTO_INCREMENT NOT NULL, bags VARCHAR(255) DEFAULT NULL, shoes VARCHAR(255) DEFAULT NULL, clothe VARCHAR(255) DEFAULT NULL, watch VARCHAR(255) DEFAULT NULL, accessory VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
